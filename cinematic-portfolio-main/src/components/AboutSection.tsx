        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              ...
              , a Full Stack Developer, Software Developer and UI/UX Designer
              focused on creating modern, functional and visually engaging
              digital products. I enjoy transforming ideas into practical
              software by combining clean interfaces, thoughtful user
              experiences and reliable development.
            </motion.p>
            ...
            >
              ...
              <div className="flex flex-col">
                <span
                  className="text-2xl sm:text-3xl font-light text-[#F4EBE2] tracking-tight"
                  style={{ fontFamily: "'Bebas Neue', sans-serif" }}
                >
                  FULL STACK
                </span>
              ...
              <div className="flex flex-col">
                <span
                  className="text-2xl sm:text-3xl font-light text-[#D4AF37] tracking-tight"
                  style={{ fontFamily: "'Bebas Neue', sans-serif" }}
                >
                  SOFTWARE
                </span>
