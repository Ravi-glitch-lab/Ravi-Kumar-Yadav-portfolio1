      ...
      <div className="relative z-10 flex flex-col justify-between h-full w-full px-6 sm:px-12 lg:px-16 pt-6 pb-8 pointer-events-none">
        ...
        <div className="relative flex flex-col md:flex-row items-center justify-between w-full pt-4 pb-2 my-auto">
          ...
          >
            ...
            >
              <p
                className="text-[10px] sm:text-xs tracking-[0.35em] uppercase text-[#C99E5D]"
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >
                RAVI KUMAR YADAV
              </p>
            ...
            >
              <p
                className="text-[10px] sm:text-[11px] md:text-xs font-normal tracking-[0.24em] uppercase text-[#C4B29E]"
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >
                FULL STACK DEVELOPER
                <span className="text-[#8C6D4F] mx-2">•</span>
                SOFTWARE DEVELOPER
                <span className="text-[#8C6D4F] mx-2">•</span>
                UI/UX DESIGNER
              </p>
            ...
            <motion.div
              variants={fadeUpVariants}
              className="text-xs sm:text-sm md:text-[13.5px] font-light text-[#A8988B] leading-[1.8] tracking-wide max-w-lg mb-6"
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              <p>
                I design and build modern digital experiences that combine
                clean interfaces with powerful functionality.
                <br />
                Turning ideas into practical software, one line of code at a time.
              </p>
            </motion.div>
