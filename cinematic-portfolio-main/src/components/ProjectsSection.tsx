...
const projects: Project[] = [
  {
    ...
    category: 'SPORTS / MOBILE APPLICATION',
    description:
      'A modern digital application created for Janakpur Bolts, focused on delivering a clean and engaging sports experience. The project combines structured content, intuitive navigation and a responsive user interface designed around the identity of the team.',
    link: '#',
    ...
    metrics: [
      ...
      { label: 'FOCUS', value: 'Sports Experience' },
...

  {
    ...
    category: 'E-COMMERCE / BEAUTY WEBSITE',
    description:
      'A modern cosmetics website designed to showcase beauty products, brands and product categories through an elegant shopping experience. The interface focuses on visual presentation, easy product discovery and a responsive customer-friendly layout.',
    link: '#',
...

  {
    ...
    description:
      'A hostel management CRM designed to simplify daily hostel operations through a centralized dashboard. The system focuses on room and floor management, resident records, payments, notifications and administrative control in one practical platform.',
    link: '#',
    buttonText: 'VIEW PROJECT',
    tech: [
      'PHP',
...

  {
    ...
    category: 'SAAS / HOSTEL MANAGEMENT PLATFORM',
    description:
      'An upcoming SaaS platform built to take hostel management beyond a single-property CRM. HostelHub is being designed as a scalable system where hostel owners can manage their properties while a super administrator oversees subscriptions, hostels and platform operations.',
    link: '#',
    ...
    metrics: [
      { label: 'MODEL', value: 'SaaS Platform' },
      { label: 'ACCESS', value: 'Admin + Hostel Owner' },
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        >
          ...
          <p
            ...
            style={{ fontFamily: "'Montserrat', sans-serif" }}
          >
            A selection of applications, websites and management systems I
            have designed and developed, alongside projects currently being
            built.
          </p>
        </motion.div>
              ...
              <div className="relative w-full rounded-2xl border border-[#8C6D4F]/50 bg-[#0E0C0A] p-8 sm:p-12 shadow-[0_25px_70px_rgba(0,0,0,0.98)] group overflow-hidden transition-colors duration-500 hover:border-[#D4AF37]">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start relative z-10">
                  ...
                  <div className="lg:col-span-5 flex flex-col justify-between h-full space-y-6 lg:pl-6 lg:border-l lg:border-[#8C6D4F]/25">
                    ...
                    {project.comingSoon ? (
                      <div
                        className="inline-flex items-center justify-center space-x-3 px-6 py-3.5 border border-[#D4AF37]/50 bg-[#16120E] text-[#D4AF37] text-[11px] font-medium tracking-[0.24em] uppercase"
                        style={{
                          fontFamily: "'Montserrat', sans-serif",
                        }}
                      >
                        <span>HOSTELHUB — COMING SOON</span>
                        <span>◆</span>
                      </div>
                    ) : (
                      <a
